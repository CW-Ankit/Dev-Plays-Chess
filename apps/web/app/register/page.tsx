      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold mb-2">Init Profile</h1>
            <p className="text-text-secondary">Initialize your developer account to start deploying victories.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Execute SignUp"}
            </Button>
          </form>
