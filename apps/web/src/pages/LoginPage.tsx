    ...
    <div className="min-h-screen bg-[#0e1116] text-[#e8e9ea] flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-[#8B949E]">Enter your credentials to access your account</p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-[#8B949E]">
          Don't have an account? <Link to="/register" className="text-emerald-400 hover:text-emerald-300 font-medium">Sign up for free</Link>
        </p>
      </motion.div>
    </div>
  );
