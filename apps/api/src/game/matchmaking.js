...
import { Chess } from "@chessdotcom/chess-logic";
import { COLOR_PREF } from "../config/constants.js";

export const waitingPlayers = new Map();
...
export const enqueuePlayer = (socket, meta) => {
...
export const removeWaitingPlayer = (socketId) => waitingPlayers.delete(socketId);

export const findMatchFor = (socketId) => {
...
export const getGameBySocket = (socketId) => {
...
export const removeSocketFromGame = (socketId) => {
