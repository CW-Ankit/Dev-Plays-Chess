...
import { AUTH_COOKIE, AUTH_TOKEN_MAX_AGE_SECONDS } from "../config/constants.js";
...
export const readSessionFromCookieHeader = (cookieHeader) => {
...
export const getSessionFromSocket = (socket) => {
